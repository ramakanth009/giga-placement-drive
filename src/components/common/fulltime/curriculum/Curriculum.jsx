...
const Curriculum = ({ 
  ...
  const getSliderStyle = () => {
    ...
    const getCardWidth = () => {
      ...
      if (screenWidth <= 375) return 240 + 20; // card width + margin
      if (screenWidth <= 480) return 270 + 22;
      if (screenWidth <= 600) return 300 + 24;
      if (screenWidth <= 960) return 350 + 24;
      if (screenWidth <= 1200) return 380 + 24;
      return 400 + 24;
    };
