      ...
      weeks: [
        {
          ...
          companies: {
            topLocations: ['Bangalore', 'Hyderabad', 'Mumbai'],
            avgSalary: '5-12 LPA',
            openings: '12,500+',
          }
        },
        {
          ...
          companies: {
            topLocations: ['Pune', 'Chennai', 'Delhi NCR'],
            avgSalary: '6-14 LPA',
            openings: '9,800+',
          }
        },
        {
          ...
          companies: {
            topLocations: ['Bangalore', 'Mumbai', 'Hyderabad'],
            avgSalary: '8-15 LPA',
            openings: '6,200+',
          }
        },
        {
          ...
          companies: {
            topLocations: ['Hyderabad', 'Delhi NCR', 'Chennai'],
            avgSalary: '7-13 LPA',
            openings: '7,500+',
          }
        },
      ...
      weeks: [
        {
          ...
          companies: {
            topLocations: ['Bangalore', 'Mumbai', 'Pune'],
            avgSalary: '5-10 LPA',
            openings: '15,000+',
          }
        },
        {
          ...
          companies: {
            topLocations: ['Bangalore', 'Hyderabad', 'Delhi NCR'],
            avgSalary: '6-12 LPA',
            openings: '8,600+',
          }
        },
