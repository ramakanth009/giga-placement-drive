// src/components/fulltime/datascience/curriculummonths/DataScienceCurriculumMonths.jsx
import React from 'react';
import CurriculumMonths from '../../../common/fulltime/curriculummonths/CurriculumMonths';

const DataScienceCurriculumMonths = () => {
  const months = [
    "Python Basics",
    "Advanced Python",
    "SQL Fundamentals",
...
export default DataScienceCurriculumMonths;