...
const FullStackProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Launch a Complete Shopping Experience! Build a feature-rich e-commerce platform with product catalogs, shopping carts, user accounts, and payment processing.",
      skills: ["Next.js/React", "Payment APIs", "Redux/Context API", "Recruitment Tech"]
    },
    {
      ...
      skills: ["WebSockets", "Full-Stack Integration", "Third-Party APIs"]
    },
    {
      title: "Additional Projects",
      image: additionalProjectImage,
